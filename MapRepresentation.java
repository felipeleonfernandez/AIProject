...
public class MapRepresentation  {
	...
	private ArrayList<Node> visitados=new ArrayList<Node>();
	private static ArrayList<String> caminoMinimo=new ArrayList<String>(); 
		...
		for (int i=0;i<aristas.size();i++) {
			...
			if(!visitados.contains(destinito)) {
				...
				if(anterior!=null && !(destinito.getLinea()%2==0 && anterior.getLinea()%2==0
					...
					/*caminoMinimo.remove(caminoMinimo.size()-1);
					String lineaAnterior=origen.getEstacion();
					String lineaSiguiente=origen.getEstacion();
					if(anterior.getLinea()%3==0) {
						lineaAnterior+="A";
					}
					else if(anterior.getLinea()%5==0) {
						lineaAnterior+="R";
					}
					else if(anterior.getLinea()%2==0) {
						lineaAnterior+="V";
					}
					if(destinito.getLinea()%3==0) {
						lineaSiguiente+="A";
					}
					else if(destinito.getLinea()%2==0) {
						lineaSiguiente+="V";
					}
					else if(destinito.getLinea()%5==0) {
						lineaSiguiente+="R";
					}
					caminoMinimo.add(lineaAnterior);
					caminoMinimo.add(lineaSiguiente);*/
					res+=2;
				}
	...
	public static ArrayList<String> getCaminoMinimo (){
		return caminoMinimo;
	}
